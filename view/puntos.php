...
<div class="container-fluid mt-3">
    <div class="row  d-flex justify-content-end">
        <!-- Columna con alineación a la derecha -->
        <div class="col-auto puntos mx-5">
            <img src="../images/moneda.png" alt="" >
            <p>12000</p>
        </div>
    </div>
</div>
    <main class="container  mb-5">
            ...
            <div class="card h-100">
                ...
                <p class="card-price card-price-puntos">200  <img src="../images/moneda.png" alt="" style="width: 40px; height: 40px;"></p>
                </div>
            ...
            <div class="card h-100">
                ...
                <p class="card-price card-price-puntos">15,00 €</p>
                </div>
                <div class="card-footer text-center">
                <a href="#" class="btn btn-primary">Añadir al carrito</a>
                </div>
            ...
            <div class="card h-100">
                ...
                <p class="card-price card-price-puntos">12,00 €</p>
                </div>
                <div class="card-footer text-center">
                <a href="#" class="btn btn-primary">Añadir al carrito</a>
                </div>
            ...
            <div class="card h-100">
                ...
                <p class="card-price card-price-puntos">18,00 €</p>
                </div>
                <div class="card-footer text-center">
                <a href="#" class="btn btn-primary">Añadir al carrito</a>
                </div>
            ...
            <div class="card h-100">
                ...
                <p class="card-price card-price-puntos">20,00 €</p>
                </div>
                <div class="card-footer text-center">
                <a href="#" class="btn btn-primary">Añadir al carrito</a>
                </div>
            ...
            <div class="card h-100">
                ...
                <p class="card-price card-price-puntos">14,00 €</p>
                </div>
                <div class="card-footer text-center">
                <a href="#" class="btn btn-primary">Añadir al carrito</a>
                </div>
